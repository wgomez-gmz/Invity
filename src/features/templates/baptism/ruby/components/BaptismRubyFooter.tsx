...
export function BaptismRubyFooter({ closing, reveal }: BaptismRubyFooterProps) {
  return (
    ...
    >
      <p className="mx-auto max-w-2xl font-serif text-4xl text-[#193252] sm:text-5xl">{closing.phrase}</p>
      <p className="mt-4 text-xs uppercase tracking-[0.26em] text-[#6c7d97]">{closing.signature}</p>
    </motion.footer>
  );
}
